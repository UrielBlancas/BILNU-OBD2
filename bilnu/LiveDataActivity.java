...
public class LiveDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, listObdCommands);
        ...
        if(mObdSelectedtoLiveDataLv.getAdapter().getCount() == 0){
            ...
            for (int i = 0; i < mObdSelectedtoLiveDataLv.getAdapter().getCount(); i++) {
                ...
                } else if (mObdSelectedtoLiveDataLv.getItemAtPosition(i).toString().equals("Presión de combustible")){
            ...
            if (action.equals(ACTION_OBD_CONNECTION_STATUS)) {
                ...
                if(mObdSelectedtoLiveDataLv.getAdapter().getCount() == 0  ){
                    ...
                    if(tripRecord.getmVehicleIdentificationNumber() == null){
                        mautoNumberTv.setText("Número de Identificación: No existe información");
                    }
                    if(tripRecord.getmVehicleIdentificationNumber() != null){
                        mautoNumberTv.setText("Número de Identificación: " + tripRecord.getmVehicleIdentificationNumber());
                    }
                    findViewById(R.id.progress_bar).setVisibility(View.GONE);
                    //tripRecord.getSpeed();
                    ...
                    TripRecord tripRecord = TripRecord.getTripRecode(LiveDataActivity.this);
                    if(tripRecord.getSpeed() == 0){
                        mObdInfoTextView.setText("Velocidad: 0 km/h");
                    }
                    if (tripRecord.getSpeed() != 0){
                        mObdInfoTextView.setText("Velocidad: " + tripRecord.getSpeed().toString() + "km/h");
                    }
                    ...
                    for(int i = 0; i<mObdSelectedtoLiveDataLv.getAdapter().getCount(); i++){
                        if((mObdSelectedtoLiveDataLv.getItemAtPosition(i).toString().equals("Presión barométrica"))){
                            ...
                            if(tripRecord.getmFuelPressure() == null){
                                listAdapter.add("Presión de combustible: No disponible");
                            }
                            else {
                                listAdapter.add("Presión de combustible: " + tripRecord.getmFuelPressure());
                            ...
                            if(tripRecord.getmEngineOilTemp() == null){
                                listAdapter.add("Temperatura del aceite: No disponible");
                            }
                            else{
                            ...
                            if(tripRecord.getmWideBandAirFuelRatio() == null){
                                ...
                                listAdapter.add("Relación aire-combustible de banda ancha: " + tripRecord.getmWideBandAirFuelRatio());
                            }
                            ...
                            if(tripRecord.getmDistanceTraveledAfterCodesCleared() == null){
                                listAdapter.add("Distancia viajada antes de limpiar los codigos: No disponible");
                            }
                            else{
                            ...
                            if(tripRecord.getEngineRuntime() == null){
                                listAdapter.add("Avance de tiempo: No disponible");
                            }
                            else {
                            ...
                            if(tripRecord.getmPermanentTroubleCode() == null){
                                listAdapter.add("Códigos de problemas permanentes: 0");
                            }
                            else{
                            ...
                            if(tripRecord.getmAbsLoad() == null){
                                listAdapter.add("Comando de carga absoluta: No disponible");
                            }
                            else{
